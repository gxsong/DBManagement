...
public class LockScheduleTest {
    ...
    public void shareWaitForExclusive() {
        steps = new Schedule.Step[]{
                ...
                new Schedule.Step(tid1, pid1, Schedule.Action.SHARED), //t1 upgrades
                new Schedule.Step(tid1, pid1, Schedule.Action.ACQUIRED), //t1 gets exclusive lock

                new Schedule.Step(tid0, pid1, Schedule.Action.EXCLUSIVE), //t2 requests shared, should wait for t1
                new Schedule.Step(tid1, pid1, Schedule.Action.EXCLUSIVE),    // now t2 can get exclusive
               new Schedule.Step(tid0, pid1, Schedule.Action.UNLOCK),
